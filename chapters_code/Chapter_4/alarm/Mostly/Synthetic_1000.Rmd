...
```{r}
synthetic_1000 = read.csv("/alarm/Synthetic/Mostly/alarm_1000_syn.csv")
synthetic_1000[sapply(synthetic_1000, is.character)] <- 
  lapply(synthetic_1000[sapply(synthetic_1000, is.character)],as.factor)
synthetic_1000[sapply(synthetic_1000, is.logical)] <- 
  lapply(synthetic_1000[sapply(synthetic_1000, is.logical)],as.factor)
