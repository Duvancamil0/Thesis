...
```{r}
synthetic_500 = read.csv("/alarm/Synthetic/Mostly/alarm_500_syn.csv")
synthetic_500[sapply(synthetic_500, is.character)] <- 
  lapply(synthetic_500[sapply(synthetic_500, is.character)],as.factor)
synthetic_500[sapply(synthetic_500, is.logical)] <- 
  lapply(synthetic_500[sapply(synthetic_500, is.logical)],as.factor)
