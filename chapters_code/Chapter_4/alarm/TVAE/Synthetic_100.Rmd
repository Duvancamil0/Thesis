---
title: "Learning BNs - ALARM synthetic 100"
...
```{r}
df <- read.csv("/alarm/alarm.csv", colClasses = "factor")
```
Original BN
```{r}
...
```{r}
stratified_100 = read.csv("/alarm/Samples/stratified_100.csv", colClasses = "factor")
...
```{r}
synthetic_100 = read.csv("/alarm/Synthetic/TVAE/alarm_100_syn.csv", colClasses = "character")
synthetic_100[synthetic_100 == "False"] <- "FALSE"
synthetic_100[synthetic_100 == "True"] <- "TRUE"
