...
```{r}
synthetic_500 = read.csv("/sports/Synthetic/TVAE/sports_500_syn.csv")
...
write.csv(synthetic_500_u_2, "/sports/Augdata/TVAE/aug_500_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_5, "/sports/Augdata/TVAE/aug_500_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_10, "/sports/Augdata/TVAE/aug_500_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_20, "/sports/Augdata/TVAE/aug_500_20.csv", row.names=FALSE)
```
