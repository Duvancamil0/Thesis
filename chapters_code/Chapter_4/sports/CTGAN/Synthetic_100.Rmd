---
title: "Learning BNs - SPORTS synthetic 100"
...
```{r}
stratified_100 = read.csv("/sports/Samples/stratified_100.csv")
...
```{r}
synthetic_100 = read.csv("/sports/Synthetic/CTGAN/sports_100_syn.csv")
synthetic_100[sapply(synthetic_100, is.character)] <- 
  lapply(synthetic_100[sapply(synthetic_100, is.character)],as.factor)
synthetic_100[sapply(synthetic_100, is.numeric)] <- 
  lapply(synthetic_100[sapply(synthetic_100, is.numeric)],as.factor)
...
write.csv(synthetic_100_u_2, "/sports/Augdata/CTGAN/aug_100_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_5, "/sports/Augdata/CTGAN/aug_100_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_10, "/sports/Augdata/CTGAN/aug_100_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_20, "/sports/Augdata/CTGAN/aug_100_20.csv", row.names=FALSE)
```
