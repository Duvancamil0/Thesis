...
```{r}
synthetic_500 = read.csv("/sports/Synthetic/CTGAN/sports_500_syn.csv")
synthetic_500[sapply(synthetic_500, is.character)] <- 
  lapply(synthetic_500[sapply(synthetic_500, is.character)],as.factor)
synthetic_500[sapply(synthetic_500, is.numeric)] <- 
  lapply(synthetic_500[sapply(synthetic_500, is.numeric)],as.factor)
...
write.csv(synthetic_500_u_2, "/sports/Augdata/CTGAN/aug_500_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_5, "/sports/Augdata/CTGAN/aug_500_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_10, "/sports/Augdata/CTGAN/aug_500_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_20, "/sports/Augdata/CTGAN/aug_500_20.csv", row.names=FALSE)
```
