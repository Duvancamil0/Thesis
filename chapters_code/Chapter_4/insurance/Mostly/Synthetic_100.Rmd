...
```{r}
stratified_100 = read.csv("/insurance/Samples/stratified_100.csv")
...
```{r}
levels(stratified_100$ThisCarCost) <- c(levels(stratified_100$ThisCarCost), 'Million')
levels(stratified_100$Theft) <- c(levels(stratified_100$Theft), 'True')
levels(stratified_100$MedCost) <- c(levels(stratified_100$MedCost),'Million')
levels(stratified_100$ILiCost) <- c(levels(stratified_100$ILiCost),'Million')
...
```{r}
synthetic_100 = read.csv("/insurance/Synthetic/Mostly/insurance_100_syn.csv")
...
Add the missing levels
```{r}
levels(synthetic_100$ThisCarCost) <- c(levels(synthetic_100$ThisCarCost), 'Million')
levels(synthetic_100$Theft) <- c(levels(synthetic_100$Theft), 'True')
levels(synthetic_100$MedCost) <- c(levels(synthetic_100$MedCost),'Million')
levels(synthetic_100$ILiCost) <- c(levels(synthetic_100$ILiCost),'Million')
