...
```{r}
synthetic_500 = read.csv("/prm/Synthetic/Mostly/prm_500_syn.csv")
...
write.csv(synthetic_500_u_2, "/prm/Augdata/Mostly/aug_500_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_5, "/prm/Augdata/Mostly/aug_500_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_10, "/prm/Augdata/Mostly/aug_500_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_20, "/prm/Augdata/Mostly/aug_500_20.csv", row.names=FALSE)
```
