...
```{r}
synthetic_1000 = read.csv("/prm/Synthetic/TVAE/prm_1000_syn.csv")
...
write.csv(synthetic_1000_u_2, "/prm/Augdata/TVAE/aug_1000_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_5, "/prm/Augdata/TVAE/aug_1000_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_10, "/prm/Augdata/TVAE/aug_1000_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_20, "/prm/Augdata/TVAE/aug_1000_20.csv", row.names=FALSE)
```
