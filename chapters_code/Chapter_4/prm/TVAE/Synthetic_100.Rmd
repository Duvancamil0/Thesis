...
```{r}
synthetic_100 = read.csv("/prm/Synthetic/TVAE/prm_100_syn.csv")
...
write.csv(synthetic_100_u_2, "/prm/Augdata/TVAE/aug_100_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_5, "/prm/Augdata/TVAE/aug_100_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_10, "/prm/Augdata/TVAE/aug_100_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_20, "/prm/Augdata/TVAE/aug_100_20.csv", row.names=FALSE)
```
