...
```{r}
synthetic_100 = read.csv("/asia/Synthetic/CTGAN/asia_100_syn.csv")
...
write.csv(synthetic_100_u_2, "/asia/Augdata/CTGAN/aug_100_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_5, "/asia/Augdata/CTGAN/aug_100_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_10, "/asia/Augdata/CTGAN/aug_100_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_100_u_20, "/asia/Augdata/CTGAN/aug_100_20.csv", row.names=FALSE)
```
