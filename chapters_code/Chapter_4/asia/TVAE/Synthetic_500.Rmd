...
```{r}
synthetic_500 = read.csv("/asia/Synthetic/TVAE/asia_500_syn.csv")
...
write.csv(synthetic_500_u_2, "/asia/Augdata/TVAE/aug_500_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_5, "/asia/Augdata/TVAE/aug_500_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_10, "/asia/Augdata/TVAE/aug_500_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_20, "/asia/Augdata/TVAE/aug_500_20.csv", row.names=FALSE)
```
