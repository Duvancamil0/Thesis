---
title: "Learning BNs - ASIA synthetic 1000"
...
```{r}
stratified_1000 = read.csv("/asia/Samples/stratified_1000.csv")
...
```{r}
synthetic_1000 = read.csv("/asia/Synthetic/Mostly/asia_1000_syn.csv")
...
write.csv(synthetic_1000_u_2, "/asia/Augdata/Mostly/aug_1000_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_5, "/asia/Augdata/Mostly/aug_1000_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_10, "/asia/Augdata/Mostly/aug_1000_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_1000_u_20, "/asia/Augdata/Mostly/aug_1000_20.csv", row.names=FALSE)
```
