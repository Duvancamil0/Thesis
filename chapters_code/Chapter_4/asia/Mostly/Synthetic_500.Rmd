---
title: "Learning BNs - ASIA synthetic 500"
...
```{r}
stratified_500 = read.csv("/asia/Samples/stratified_500.csv")
...
```{r}
synthetic_500 = read.csv("/asia/Synthetic/Mostly/asia_500_syn.csv")
...
write.csv(synthetic_500_u_2, "/asia/Augdata/Mostly/aug_500_2.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_5, "/asia/Augdata/Mostly/aug_500_5.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_10, "/asia/Augdata/Mostly/aug_500_10.csv", row.names=FALSE)
```
...
write.csv(synthetic_500_u_20, "/asia/Augdata/Mostly/aug_500_20.csv", row.names=FALSE)
```
